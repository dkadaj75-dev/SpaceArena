    ...
    const samples: AnyConfig[] = [
      {
        ...
        core: {
          ...
          power: { capacity: 0 }, efficiency: { energyDraw: 0 },
          sensors: { lockRange: 1, lockTimeSec: 1, coneDeg: 1 },
        },
        upgradeTracks: { hull: "upgrade.h", engine: "upgrade.e", energy: "upgrade.n" },
      ...
      { id: "module.x", type: "module", version: 1, onFire: ["action.a"], onActivate: ["action.c"], onDeactivate: ["action.d"] },
      {
